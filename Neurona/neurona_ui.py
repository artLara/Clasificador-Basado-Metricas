...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 536, 638))
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 553, 64))
        ...
        self.doubleSpinBoxLearningRate.setMinimum(0.0001)
        self.doubleSpinBoxLearningRate.setMaximum(1.0)
        self.doubleSpinBoxLearningRate.setSingleStep(0.01)
        self.doubleSpinBoxLearningRate.setProperty("value", 0.1)
        ...
        self.doubleSpinBoxError = QtWidgets.QDoubleSpinBox(self.scrollAreaWidgetContents_5)
        self.doubleSpinBoxError.setDecimals(4)
        self.doubleSpinBoxError.setMinimum(0.0001)
        self.doubleSpinBoxError.setSingleStep(0.0001)
        self.doubleSpinBoxError.setProperty("value", 0.0001)
        self.doubleSpinBoxError.setObjectName("doubleSpinBoxError")
        self.horizontalLayout_3.addWidget(self.doubleSpinBoxError)
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 531, 65))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 536, 638))
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 536, 638))
        ...
        self.scrollAreaWidgetContents_6.setGeometry(QtCore.QRect(0, 0, 536, 638))
        ...
        self.scrollAreaWidgetContents_8.setGeometry(QtCore.QRect(0, 0, 512, 260))
        ...
        self.scrollAreaWidgetContents_7.setGeometry(QtCore.QRect(0, 0, 512, 259))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_12.setText(_translate("MainWindow", "Épocas"))
        self.label_13.setText(_translate("MainWindow", "Factor de aprendizaje"))
        self.label_9.setText(_translate("MainWindow", "Error mínimo permitido"))
